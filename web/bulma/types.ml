...
type section_attrib = Html_types.section_attrib
type div_content_fun = Html_types.div_content_fun
type section_content_fun = Html_types.section_content_fun
type 'a section = [> Html_types.section] as 'a
...
module type HTML_SIG = sig
  ...
  val section : ( section_attrib ,  section_content_fun , 'a section ) star
