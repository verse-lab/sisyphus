...
:Effort:   4:00
:END:
*** DONE Work out appropriate tactic for xif
CLOSED: [2022-10-10 Mon 08:44]
*** DONE Update symexec to handle if then else and if then constructs
CLOSED: [2022-10-10 Mon 08:44]
*** DONE Add handling for ref allocations
CLOSED: [2022-10-10 Mon 08:54]
*** TODO Hacker mode
