...
(rule
     (target stack_filter_new.sisyphus.ml)
     (deps stack_filter_new.ml)
     (action (with-stdout-to stack_filter_new.sisyphus.ml
          (run sed -E "s/\\[@.*\\]//" stack_filter_new.ml))))

(rule
 (target Stack_filter_new_ml.v)
 (deps stack_filter_new.sisyphus.ml ../common/Arr_ml.v
...
(rule
     (target stack_filter_old.sisyphus.ml)
     (deps stack_filter_old.ml)
     (action (with-stdout-to stack_filter_old.sisyphus.ml
          (run sed -E "s/\\[@.*\\]//" stack_filter_old.ml))))

(rule
 (target Stack_filter_old_ml.v)
 (deps stack_filter_old.sisyphus.ml ../common/Arr_ml.v
../common/Combinators_ml.v
../common/Hashtbl_ml.v
../common/Lst_ml.v
../common/Opt_ml.v
